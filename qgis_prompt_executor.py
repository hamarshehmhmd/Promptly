...
class QGISPromptExecutor:
    ...
    def initGui(self):
        ...
        # If icon.png doesn't exist, proceed without it
    ...
    def run(self):
        ...
        # Only create a new dialog if none yet exists
        if self.first_start:
            self.first_start = False
            self.dlg = QGISPromptExecutorDialog()
        ...
        if result:
            pass  # No action needed after dialog close 